...
for (i in 1:length(listFiles))
{
    ...
    fCorpus <- VCorpus(VectorSource(f))
    ...
    freq2 <- sort(row_sums(t3), decreasing=TRUE)
    freq2 <- sort(row_sums(t4), decreasing=TRUE)
    ...
    save(t1, file=paste("t1_",listFiles[i],".RData", sep=""))
    save(t2, file=paste("t2_",listFiles[i],".RData", sep=""))
    save(t3, file=paste("t3_",listFiles[i],".RData", sep=""))
    save(t4, file=paste("t4_",listFiles[i],".RData", sep=""))
