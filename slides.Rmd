...
2. we remove punctuation, numbers, stopwords  and multiple whitespace.    
...
![](./assets/img/PredictORama2.png)  
First you choice on the left which corpus you want to use : with or without stop words.   
Next simply write a sentence on the "sentence" box and wait a little the seven buttons on the bottom will have their label update by the 7 best predict words.  
If you click on a button you add the word to your sentence and you can repeat if you want.   

### <u>Memory optimisation</u>
To optimize the memory of [The Shiny App](https://ervachon.shinyapps.io/Capston_Project), we truncate the n-gram corpus:  we select only 1-gram with minimum 2 occurences, 2-gram with minimum 4, 3-gram with minimum 5 and 4-gram with minimum 5.
